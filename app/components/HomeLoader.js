...
const HomeLoader = ({ children }) => {
  ...
  return (
    <>
      <div
        className={
          isLoading ? "home-page-content is-loading" : "home-page-content"
        }
      >
        {children}
      </div>
      ...
      {isLoading && (
        <div
          ...
          role="status"
          aria-live="polite"
          aria-label="Loading The Burger House"
        >
          <span
            className="home-loader__orb home-loader__orb--one"
            aria-hidden="true"
          />
          <span
            className="home-loader__orb home-loader__orb--two"
            aria-hidden="true"
          />
